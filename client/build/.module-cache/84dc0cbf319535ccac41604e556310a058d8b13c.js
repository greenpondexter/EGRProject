      ...
      React.createElement("div", {style: this.style}, 
        React.createElement(ContainerHeader, null), 
          React.createElement("div", {class: "MIEGRsliderHolder"}, 
            ...
            React.createElement(DateTextDisplay, {startDate: this.props.data.startDate2, endDate: this.props.data.endMonth2, months: this.props.data.months, labelText: this.props.data.textBox2})
          )
      )
