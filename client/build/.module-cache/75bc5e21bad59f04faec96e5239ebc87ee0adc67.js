  ...
  render: function () {
    return (
      React.createElement("div", null, 
        ...
        React.createElement("input", {type: "text", id: "firstPeriodTextBox", value: this.props.startDate, readonly: true, style: "border:0; color:#969696; background-color:#f9f9f9; font-weight:bold;"})
      )
    );
  }
});
