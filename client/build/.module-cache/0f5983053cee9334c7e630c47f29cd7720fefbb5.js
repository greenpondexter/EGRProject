      ...
      React.createElement("div", {style: this.style}, 
        React.createElement(ContainerHeader, null), 
          React.createElement("div", {class: "MIEGRsliderHolder"}, 
            ...
            React.createElement(DateTextDisplay, {startMonth: this.props.data.startDate1, endDate: this.props.data.endDate1, months: this.props.data.months, labelText: this.props.data.textBox1}), 
            React.createElement(Slider, {data: this.props.data, whichSlider: 2}), 
            React.createElement(DateTextDisplay, {startMonth: this.props.data.startDate2, endDate: this.props.data.endMonth2, months: this.props.data.months, labelText: this.props.data.textBox2})
          )
      )
